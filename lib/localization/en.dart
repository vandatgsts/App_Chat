const enString = {
  ...
  "drag":
      "Drag peer message from left to right to delete conversations til that message.",
  ...
  "setpasslong":
      "The following be used to reset your passcode in case you forget it. Frame a question that you can answer. Be creative and choose an answer that is difficult to guess.",
  ...
  "mediamssgnotallowed":
      "Media Messages sending is temporarily disabled by Admin.",
  "textmssgnotallowed":
      "Text Messages sending is temporarily disabled by Admin.",
  ...
  "newnotifications": "New Notification received",
  ...
  "confirm": "Confirm",
  "deletedgroup":
      "This Group Has been deleted by Admin OR you have been removed from this group.",
  "onlyadminsend": "🔒 Only admin can send messages in this Group",
  ...
  "reportsuccess":
      "You report has been successfully submitted to Admin. Admin will review it shortly & take neccessary action if needed",
  "deletethischat": "Delete Chat",
  "suredelete":
      "Chat Conversations will be completely deleted from sender and reciever device",
  ...
  "backupdesc":
      "All Chat Conversations & Media data are automatically backed up in secure cloud servers and are synced across all your devices. You can continue chat using any device, anytime.",
  "mute": "Mute",
  "mutenotifications": "Mute Notifications",
  "unmute": "Unmute",
  "unmutenotifications": "Unmute Notifications",
  "longpressforvideo": "Press & hold for video",
  "generalnotification": "Notifications Settings",
  "generalnotificationdesc": "Call Ringing & Alerts",
  "deleteaccount": "Delete Account",
  "raiserequest": "Request account deletion",
  "raiserequestdesc":
      "Submit a request to Administrator to delete the Account. Your account will be deleted within 5 days.",
  "requestsubmitted": "Account Deletion Request Submitted successfully !",
  "deleteallchats": "Delete all Chats",
  "areyousuretodeletechat": "Are you sure you want to delete all chats ?",
  "sharelocation": "Share Location",
  "open": "Navigate to",
  "synctoweb": "Sync Contacts to Web",
  "nocontactsavailable": "No Contacts available to sync",
  "synctowebdesc": "Sync (####) available contacts to Web.",
  "logintoweb": "Login to the Web App to start Chat & Calls in Web browser",
  "syncnow": "Sync Now",
  "syncsuccess": "Synced Successfully",
  "failedtosync": "Failed to Sync !",
  "deletesync": "Delete Synced Contacts",
  "syncdeleted": "Synced Contacts Deleted Successfully !",
  "lastsynced": "Last Synced",
  "nosyncedcontacts": "No Synced Contacts Available",
  "loginto": "Login to",
  "androidiosapp": "Android / IOS app",
  "appdescription":
      "Send & Recieve Messages without Phone. Chat Anytime, Anywhere !",
  "logintoyouraccount": "Login to your Account",
  "nosynced": "No Synced Contacts",
  "theme": "Theme",
  "light": "Light",
  "dark": "Dark",
  "language": "Language",
  "failedtoloadchat":
      "Failed. Kindly delete the Chat Tile and send a new message !",
  "doubletaptogoback": "Double Tap To Go Back",
  "reply": "Reply",
  "trim": "Trim",
  "cover": "Cover",
  "no": "No",
  ...
  "usecontacts": "Use your Contact List",
  "usecontactsdesc":
      "To make it easier to connect with Contacts who are available for Chats & Calls. The App uses your Contact list only to suggest the available contacts & to show their Status Stories if available. App does not store or transmit the Contact List to any server.",
